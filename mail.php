...
$site_top = "http://nagai3306.php.xdomain.jp/portfolio/index.html";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "shogosoccer6@icloud.com";
...
$thanksPage = "http://nagai3306.php.xdomain.jp/portfolio/thanks.html";
...
$require = array("name"."Email"."tel"."messeage");
